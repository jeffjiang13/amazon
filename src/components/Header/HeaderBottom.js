...
const HeaderBottom = () => {
  ...
  return (
    ...
    <ul className="flex items-center gap-1 text-sm tracking-wide">
      ...
      <li className="hidden md:inline-flex headerHover">Clinic</li>
      ...
      <li className="hidden md:inline-flex headerHover">New Releases</li>
      ...
      <li className="hidden md:inline-flex headerHover">One Medical</li>
    </ul>
    <ul className="flex items-center">
      <li className="hidden md:inline-flex headerHover">Make every day Earth Day</li>
    </ul>
  </div>
      {/* ======================= List Items End here ========================== */}
      {/* ======================= SideBar Start here =========================== */}
