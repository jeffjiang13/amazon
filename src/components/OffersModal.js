          ...
          <div className={classes.FAQ}>
            <ul className={classes.ul}>
              ...
              <li>
                ...
                <Typography className={classes.answer}>
                  EMI is available only on purchases above $ 3,000. As long as
    ...
    <div>
      ...
      {backShow && offer1 && (
        <div className={classes.body}>
          ...
          <Typography className={classes.descOffer}>
            ...
            Transactions. Minimum purchase value $ 1000
          </Typography>
          ...
          <ol className={classes.ol}>
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                or exceeds $ 1,000 on a per transaction basis. Cardholders
      ...
      {backShow && offer2 && (
        <div className={classes.body}>
          ...
          <Typography className={classes.descOffer}>
            10% Instant Discount up to $ 500 on Bank of Baroda Credit Card
            Transactions. Minimum purchase value $ 2000
          </Typography>
          <Typography className={classes.promotionTermsOffer}>
            Promotion Terms
          </Typography>
          ...
          <ol className={classes.ol}>
            ...
            <li>
              ...
              <Typography className={classes.termsBody}>
                The maximum discount possible upto $ 2000. Refer the below
                table:
              </Typography>
          ...
          <ol className={classes.ol}>
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                minimum purchase of $ 7000 per transaction (and $ 2000 for
                Fashion category)
              </Typography>
            </li>
            <li>
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                transaction value falls below $ 7000 (and $ 2000 for Fashion
